...
void Meshes() {
	...
	meshes["FloorB"] = mesh(geometry_builder::create_box(vec3(245.0f, 10.0f, 50.0f)));
	meshes["Carpet"] = mesh(geometry_builder::create_box(vec3(50.0f, 1.0f, 360.0f)));
	// ***** Move and Scale *****
	...
	// ***** Create Front Walls *****
	meshes["WallFrontA"] = mesh(geometry_builder::create_box(vec3(100.0f, 100.0f, 5.0f)));
	meshes["WallFrontB"] = mesh(geometry_builder::create_box(vec3(100.0f, 100.0f, 5.0f)));
	meshes["WallFrontAB"] = mesh(geometry_builder::create_box(vec3(50.0f, 50.0f, 5.0f)));
	// ***** Move and Scale *****
	...
	// ***** Create Right Wall *****
	meshes["WallRight"] = mesh(geometry_builder::create_box(vec3(5.0f, 100.0f, 400.0f)));
	// ***** Move and Scale *****
	meshes["WallRight"].get_transform().position = vec3(122.5f, 50.0f, 0.0f);
	//**********************************************************************************//

	// ***** Create Left Wall *****
	meshes["WallLeft"] = mesh(geometry_builder::create_box(vec3(5.0f, 100.0f, 400.0f)));
	// ***** Move and Scale *****
	meshes["WallLeft"].get_transform().position = vec3(-122.5f, 50.0f, 0.0f);
	//**********************************************************************************//

	// ***** Create Back Wall *****
	meshes["WallBack"] = mesh(geometry_builder::create_box(vec3(250.0f, 100.0f, 5.0f)));
	// ***** Move and Scale *****
	meshes["WallBack"].get_transform().position = vec3(0.0f, 50.0f, -197.5f);
	//**********************************************************************************//

	// ***** Create Roof *****
	meshes["WallTop"] = mesh(geometry_builder::create_box(vec3(250.0f, 5.0f, 400.0f)));
	// ***** Move and Scale *****
	meshes["WallTop"].get_transform().position = vec3(0.0f, 100.0f, 0);
	//**********************************************************************************//

	// ***** Create Roof Pillar *****
	meshes["Roof"] = mesh(geometry_builder::create_pyramid(vec3(250.0f, 100.0f, 400.0f)));
	// ***** Move and Scale *****
	meshes["Roof"].get_transform().position = vec3(0.0f, 152.5f, 0);
	//**********************************************************************************//

	// ***** Create Front Pillars *****
	meshes["PillarFront"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(25.0f, 275.0f, 25.0f)));
	meshes["PillarFrontB"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(25.0f, 275.0f, 25.0f)));
	// ***** Move and Scale *****
	...
	// ***** Create Back Pillars *****
	meshes["PillarBack"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(25.0f, 275.0f, 25.0f)));
	meshes["PillarBackB"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(25.0f, 275.0f, 25.0f)));
	// ***** Move and Scale *****
	...
	// ***** Create Stands *****
	meshes["Stand"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(10.0f, 100.0f, 10.0f)));
	meshes["StandB"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(10.0f, 100.0f, 10.0f)));
	meshes["StandC"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(10.0f, 100.0f, 10.0f)));
	meshes["StandD"] = mesh(geometry_builder::create_cylinder(40, 40, vec3(10.0f, 100.0f, 10.0f)));
	meshes["StandE"] = mesh(geometry_builder::create_box(vec3(50.0f, 50.0f, 50.0f)));
	// ***** Move and Scale *****
